Feature: Phone Number Component
  ...
  Scenario: Fill out optional phone number component with empty input
    Given I start the "test-optional-phonenumber-component" form
    When I click the submit button
    Then I should see the summary page which contains "Not provided" for question "Test Phone Number component" with name "phonenumber"
