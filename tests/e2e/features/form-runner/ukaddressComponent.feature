Feature: UK Address Component
 ...
 Scenario: Fill out text component correctly with essential data
  ...
  Scenario: Fill out optional UK address component with empty input
    Given I start the "test-optional-ukaddress-component" form
    When I click the submit button
    Then I should see the summary page which contains "Not provided" for question "Test UK Address component" with name "ukaddress"
