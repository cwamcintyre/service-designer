...
import GDSButtonLink from '../src/GDSButtonLink';

describe('GDSButtonLink Component', () => {
    it('renders the link with the correct text', () => {
        render(<GDSButtonLink text="Click Me" href="/example" />);
    ...
    it('renders the link with target="_blank" when specified', () => {
        render(<GDSButtonLink text="Click Me" href="/example" target="_blank" />);
        const link = screen.getByRole('link');
    ...
    it('ensures the link has accessible attributes', () => {
        render(<GDSButtonLink text="Accessible Link" href="/example" />);
    ...
    it('renders the link with additional classes when specified', () => {
        render(<GDSButtonLink text="Styled Link" href="/example" className="custom-class" />);
        const link = screen.getByRole('link');
        expect(link).toHaveClass('custom-class');
    });

    it('should not have any accessibility violations', async () => {
        const { container } = render(<GDSButtonLink text="Accessible Button" href="/example" />);
